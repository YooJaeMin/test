...
<div align="center">
	...
	<h2>이용약관</h2>
	<div class="terms_box" id="eff1" style="max-height: 20%; overflow: scroll;"><!-- max가 넘어가는 부분은 스크롤 처리 하겠다 -->
...
<div class="article">
	...
	<div class="terms_box" id="eff2" style="max-height: 20%; overflow: scroll;"><!-- max가 넘어가는 부분은 스크롤 처리 하겠다 -->
...
<script>
	$("#a1").on("click", function(){
		$("#eff1").slideUp(1000);
		$("#eff2").slideUp(1000);		
		$(".sub").each(function(){  //클래스 이름이 sub인 애들을 묶어서 제어
	...
	function enableCheck() {
		...
		if(cnt==2) {
			...
			$("#a1").prop("checked", false);  //id로 접근해서 개개인 별로 제어
